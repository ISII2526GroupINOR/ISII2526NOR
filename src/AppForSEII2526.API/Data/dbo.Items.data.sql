...
INSERT INTO [dbo].[Items] ([Id], [Name], [Description], [PurchasePrice], [QuantityAvailableForPurchase], [QuantityForRestock], [RestockPrice], [BrandId], [TypeItemId]) VALUES (3, N'Resistance Band', N'Band for exercising', CAST(10.00 AS Decimal(5, 2)), 12, 5, CAST(7.00 AS Decimal(5, 2)), 1, 2)
...
INSERT INTO [dbo].[Items] ([Id], [Name], [Description], [PurchasePrice], [QuantityAvailableForPurchase], [QuantityForRestock], [RestockPrice], [BrandId], [TypeItemId]) VALUES (7, N'16 Kg Kettlebell', N'Circular dumbbell with handle upon ', CAST(35.00 AS Decimal(5, 2)), 6, 2, CAST(28.00 AS Decimal(5, 2)), 4, 1)
